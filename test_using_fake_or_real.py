...
from fakeORreal import predict_real_or_fake  # Import the real/fake prediction function
...
def test_face_recognition_model(test_path, model_save_path, output_path , times =  "time_of_testing.pkl"):
    ...
    for file in os.listdir(test_path):
        ...
        try:
            ...
            prediction = predict_real_or_fake(img_path)
            if prediction != "real":
                print(f"🚫 FAKE IMAGE DETECTED: {file} — Skipping recognition.")
                continue  # Skip processing if the image is fake
